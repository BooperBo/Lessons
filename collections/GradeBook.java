...
public class GradeBook {
    ...
    public static void main(String[] args) {
        int[][] gradesArray = {{87, 96, 70},
                ...
                {76, 72, 84},
                {87, 93, 73}};
        System.out.println("Minimal calc grade " + calcMin(gradesArray));
        System.out.println("Maximal calc grade " + calcMax(gradesArray));
    ...
    private static double calcAverage(double... args) { //аргументы перменной длины
        double sum = 0;
        for (double i : args) {
            sum = sum + i;
        }
